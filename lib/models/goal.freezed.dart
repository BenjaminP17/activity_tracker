...
mixin _$Goal {
 ...
 int get id; double get targetKm; DateTime get targetDate; bool get isActive; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,targetKm,targetDate,isActive,createdAt);

@override
String toString() {
  return 'Goal(id: $id, targetKm: $targetKm, targetDate: $targetDate, isActive: $isActive, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, double targetKm, DateTime targetDate, bool isActive, DateTime createdAt
});
...
/// Create a copy of Goal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? targetKm = null,Object? targetDate = null,Object? isActive = null,Object? createdAt = null,}) {
  return _then(Goal(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,targetKm: null == targetKm ? _self.targetKm : targetKm // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  double targetKm,  DateTime targetDate,  bool isActive,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Goal() when $default != null:
return $default(_that.id,_that.targetKm,_that.targetDate,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  double targetKm,  DateTime targetDate,  bool isActive,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Goal():
return $default(_that.id,_that.targetKm,_that.targetDate,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  double targetKm,  DateTime targetDate,  bool isActive,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Goal() when $default != null:
return $default(_that.id,_that.targetKm,_that.targetDate,_that.isActive,_that.createdAt);case _:
  return null;
...
class _Goal implements Goal {
  const _Goal({required this.id, required this.targetKm, required this.targetDate, required this.isActive, required this.createdAt});
...
/// Create a copy of Goal
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? targetKm = null,Object? targetDate = null,Object? isActive = null,Object? createdAt = null,}) {
  return _then(_Goal(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,targetKm: null == targetKm ? _self.targetKm : targetKm // ignore: cast_nullable_to_non_nullable
as double,targetDate: null == targetDate ? _self.targetDate : targetDate // ignore: cast_nullable_to_non_nullable
